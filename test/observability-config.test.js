...
describe('observability configuration',()=>{
  ...
  it('ships a valid provisioned dashboard',async()=>{const dashboard=JSON.parse(await readFile('ops/grafana/dashboards/overview.json','utf8'));assert.equal(dashboard.uid,'tonatiuh-overview');assert.ok(dashboard.panels.length>=6);
